...
if exists('g:lightline')
  ...
  if s:is_dark
    ...
    let s:p.insert.left = [ [ s:bg10, s:rose, 'bold' ], [ s:bg9, s:fg4 ] ]
    let s:p.insert.right = [ [ s:bg10, s:rose ], [ s:bg9, s:fg4 ] ]
    let s:p.insert.middle = [ [ s:fg4, s:bg3 ] ]
    ...
    let s:p.replace.middle = [ [ s:fg4, s:bg2 ] ]
    let s:p.visual.left = [ [ s:fg1, s:bg2, 'bold' ], [ s:bg9, s:fg4 ] ]
    let s:p.visual.right = [ [ s:fg1, s:bg2 ], [ s:bg9, s:fg4 ] ]
