...
if exists('g:lightline')
  ...
  if s:is_dark
    ...
    let s:p.insert.left = [ [ s:bg0, s:light_blue, 'bold' ], [ s:fg1, s:bg2 ] ]
    ...
    let s:p.visual.left = [ [ s:bg0, s:light_blue, 'bold' ], [ s:bg0, s:bg4 ] ]
    let s:p.visual.right = [ [ s:bg0, s:light_blue ], [ s:bg0, s:bg4 ] ]
    ...
    let s:p.visual.middle = [ [ s:bg1, s:bg9 ] ]
    let s:p.tabline.left = [ [ s:fg4, s:bg2 ] ]
    let s:p.tabline.tabsel = [ [ s:bg0, s:fg4 ] ]
    let s:p.tabline.middle = [ [ s:bg0, s:bg0 ] ]
    let s:p.tabline.right = [ [ s:bg0, s:blue ] ]
