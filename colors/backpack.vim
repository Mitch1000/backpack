...
call s:HL('BackpackStainYellowItalic', s:stain_yellow, s:none, s:italic)
...
call s:HL('BackpackBrightRedItalic', s:bright_red, s:none, s:italic)
call s:HL('BackpackGreen', s:green)
call s:HL('BackpackGreenBold', s:green, s:none, s:bold)
call s:HL('BackpackGreenItalic', s:green, s:none, s:italic)
...
call s:HL('BackpackRoseItalic', s:rose, s:none, s:italic)
...
call s:HL('BackpackBlueItalic', s:blue, s:none, s:italic)
...
call s:HL('BackpackNeonBlueItalic', s:neon_blue, s:none, s:italic)
call s:HL('BackpackBabyBlue', s:baby_blue)
call s:HL('BackpackBabyBlueBold', s:baby_blue, s:none, s:bold)
call s:HL('BackpackBabyBlueItalic', s:baby_blue, s:none, s:italic)
call s:HL('BackpackExtraLightBlue', s:extra_light_blue)
call s:HL('BackpackExtraLightBlueItalic', s:extra_light_blue, s:none, s:italic)
